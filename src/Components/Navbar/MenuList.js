    ...
    <div>
      <div className="Menu">
        ...
        <ul className={`menubarbarlist ${MenuBar ? "Inactive" : "Active"}`}>
          ...
          {/* ServiceBar */}
          <li className="Menu-Bar-Services" onClick={MenuService}>
            Services & Solutions
            <KeyboardArrowDown
          ...
          <ul
            className={`menubarbarlist ${
              MenubarService ? "Inactive" : "Active"
            }`}
          >
          ...
          {/* BrandBar */}
          <li className="Menu-Bar-Brands" onClick={MenuBrand}>
            Brands
            <KeyboardArrowDown
          ...
          {/* DealBar */}
          <li className="Menu-Bar-Delas" onClick={MenuDeal}>
            Deals
            <KeyboardArrowDown
          ...
          <ul
            className={`menubarbarlist ${MenubarDeal ? "Inactive" : "Active"}`}
          >
          ...
          {/* PublicationBar */}
          <li className="Menu-Bar-Public" onClick={MenuPublic}>
            Publications
            <KeyboardArrowDown
